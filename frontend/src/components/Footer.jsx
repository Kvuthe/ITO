...
const Footer = ({ themes, currentTheme, setTheme, showUsernameColor, setShowUsernameColor }) => {
    ...
    const themeIcons = {
        ...
        'Itt': (
            <svg width="24" height="24" viewBox="0 0 300 300">
                <defs>
                    <style>{`.cls-13{fill:#dec58a;}.cls-14{fill:#ffffff;}.cls-15{fill:#5b5659;}`}</style>
                </defs>
                <polygon className="cls-13" points="27.88 272.12 272.12 272.12 272.12 27.88 27.88 272.12"/>
                <polygon className="cls-15" points="27.88 27.88 27.88 272.12 272.12 27.88 27.88 27.88"/>
                <path className="cls-14"
                      d="M260.09,39.92v220.17H39.91V39.92h220.17M260.68,10H39.32c-16.19,0-29.32,13.13-29.32,29.32v221.36c0,16.19,13.13,29.32,29.32,29.32h221.36c16.19,0,29.32-13.13,29.32-29.32V39.32c0-16.19-13.13-29.32-29.32-29.32h0Z"/>
                <path className="cls-14"
                      d="M193.58,232.99h-65.74l-16.06,31.11h-44.92l94.85-176.15h49.68l32.62,176.15h-45.42l-5.02-31.11ZM188.56,200.37l-10.29-65.24-33.62,65.24h43.91Z"/>
            </svg>
        )
    };
